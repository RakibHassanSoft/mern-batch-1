...
// BlogCard = একটি ব্লগ কার্ড (ছবি + টাইটেল + লেখা)।
      ...
      <div className="p-5">
        ...
        {showActions && (
          <div className="mt-4 flex gap-2 border-t border-slate-100 pt-4">
            ...
            <button className="flex-1 text-sm font-medium bg-red-600 text-white px-3 py-1.5 rounded-lg hover:bg-red-700 transition">
              Delete
            </button>
          </div>
        )}
